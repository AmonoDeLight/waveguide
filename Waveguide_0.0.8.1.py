...
def plotting():
 ...
 #==========================================================================================================   
    ...
    if f > f_kr:
        fig = figure(figsize=(8, 6), facecolor="gainsboro")
...
combobox.set("TE")
combobox.grid(row=0, column=2, columnspan=2,pady=15, sticky=SW)
...
click = Button(window, text="Построить графики силовых линий", bg="gold",font=LARGE_FONT, command=plotting)
...
scale = Scale(window, orient="horizontal", from_=0, to=100, command=onScale)
label_time_entry = scale
scale.grid(row=9, column=1, columnspan=1, pady=15, sticky=SW)


label_color = Label(window, text="H-синий\n E-красный", font=LARGE_FONT, bg="gainsboro")
label_color.grid(row=0, column=3, columnspan=1, pady=10, sticky=S)
